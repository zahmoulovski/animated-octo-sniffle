<template>
  <footer :class="$style.footer">
    ...
    <p>&copy; {{ new Date().getFullYear() }} Zahmoul Med Yassine. All rights reserved. <a target="_blank" href="#" rel="noopener">Cookie Policy</a>.</p>
  ...
  <nuxt-link
    ...
    <img style="width: 40px;" src="./logo.png" alt="Home">
      ...
      <li>
        <a
          href="mailto:medyassine.zahmoul@gmail.com"
